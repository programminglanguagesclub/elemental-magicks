...
This was taken from the Idris-dev github repository.
It appears to not be included with any installation of Idris.
...
toList [] = []
toList (x :: xs) = x :: Base.BoundedList.toList xs {-changed from Data.BoundedList.toList xs-}
